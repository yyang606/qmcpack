...
void MagDensityEstimator::registerCollectables(std::vector<ObservableHelper>& h5desc, hdf_archive& file) const
{
  ...
  h5o.addProperty(const_cast<std::vector<int>&>(ng), "mesh", file);
}
